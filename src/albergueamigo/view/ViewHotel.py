...
__CHEETAH_genTime__ = 1291983845.255506
__CHEETAH_genTimestamp__ = 'Fri Dec 10 10:24:05 2010'
__CHEETAH_src__ = 'ViewHotel.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Dec 10 10:23:57 2010'
...
<ul>
''')
        for site,dist in VFN(VFSL([locals()]+SL+[globals(), builtin],"nearby_sites",True),"items",False)(): # generated from line 56, col 1
            write(u'''<li><b>''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"site.name",True) # u'$site.name' on line 57, col 8
            if _v is not None: write(_filter(_v, rawExpr=u'$site.name')) # from line 57, col 8.
            write(u'''</b> - ''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"dist",True) # u'$dist' on line 57, col 25
            if _v is not None: write(_filter(_v, rawExpr=u'$dist')) # from line 57, col 25.
            write(u''' m</li>
''')
        write(u'''</ul>
''')

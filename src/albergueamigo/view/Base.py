...
__CHEETAH_genTime__ = 1292087097.712352
__CHEETAH_genTimestamp__ = 'Sat Dec 11 15:04:57 2010'
__CHEETAH_src__ = 'Base.tmpl'
__CHEETAH_srcLastModified__ = 'Sat Dec 11 15:01:42 2010'
...
\t<div id="content">\r
\t''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"body",True) # u'$body' on line 45, col 2
        if _v is not None: write(_filter(_v, rawExpr=u'$body')) # from line 45, col 2.
        write(u'''\r
\t</div>\r
\t<!-- end #content -->\r
\t<div id="sidebar">\r
...
''')
        if VFSL([locals()]+SL+[globals(), builtin],"user",True) is not None: # generated from line 51, col 3
            write(u'''\t\t<p>Bem vindo, ''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"user.name",True) # u'$user.name' on line 52, col 17
            if _v is not None: write(_filter(_v, rawExpr=u'$user.name')) # from line 52, col 17.
            write(u'''</p>\r
''')
        else: # generated from line 53, col 3
...
\t\t\t\t<ul>\r
''')
        for hotel in VFSL([locals()]+SL+[globals(), builtin],"last_hotels",True): # generated from line 62, col 6
            write(u'''\t\t\t\t\t<li>\r
\t\t\t\t\t\t<h3><a href="/hotels/view/''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"hotel.id",True) # u'$hotel.id' on line 64, col 33
            if _v is not None: write(_filter(_v, rawExpr=u'$hotel.id')) # from line 64, col 33.
            write(u'''">''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"hotel.nome",True) # u'$hotel.nome' on line 64, col 44
            if _v is not None: write(_filter(_v, rawExpr=u'$hotel.nome')) # from line 64, col 44.
            write(u'''</a></h3>\r
\t\t\t\t\t\t<p>''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"hotel.endereco",True) # u'$hotel.endereco' on line 65, col 10
            if _v is not None: write(_filter(_v, rawExpr=u'$hotel.endereco')) # from line 65, col 10.
            write(u'''</p>\r
\t\t\t\t\t</li>\r
''')
        write(u'''\t\t\t\t</ul>\r

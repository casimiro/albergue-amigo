...
__CHEETAH_genTime__ = 1292019176.22402
__CHEETAH_genTimestamp__ = 'Fri Dec 10 20:12:56 2010'
__CHEETAH_src__ = 'Base.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Dec 10 17:02:38 2010'
...
''')
        _v = VFFSL(SL,"head",True) # '$head' on line 21, col 1
        if _v is not None: write(_filter(_v, rawExpr='$head')) # from line 21, col 1.
        write('''\r
...
\t<div id="content">\r
\t''')
        _v = VFFSL(SL,"body",True) # '$body' on line 45, col 2
        if _v is not None: write(_filter(_v, rawExpr='$body')) # from line 45, col 2.
        write('''\r
\t</div>\r
\t<!-- end #content -->\r
\t<div id="sidebar">\r
\t\t<div id="news" class="boxed1">\r
\t\t\t<h2 class="title">\xc3\x9altimos Hoteis</h2>\r
\t\t\t<div class="content">\r
\t\t\t\t<ul>\r
''')
        for hotel in VFFSL(SL,"last_hotels",True): # generated from line 53, col 6
            write('''\t\t\t\t\t<li>\r
\t\t\t\t\t\t<h3><a href="/hotels/view/''')
            _v = VFFSL(SL,"hotel.id",True) # '$hotel.id' on line 55, col 33
            if _v is not None: write(_filter(_v, rawExpr='$hotel.id')) # from line 55, col 33.
            write('''">''')
            _v = VFFSL(SL,"hotel.nome",True) # '$hotel.nome' on line 55, col 44
            if _v is not None: write(_filter(_v, rawExpr='$hotel.nome')) # from line 55, col 44.
            write('''</a></h3>\r
\t\t\t\t\t\t<p>''')
            _v = VFFSL(SL,"hotel.endereco",True) # '$hotel.endereco' on line 56, col 10
            if _v is not None: write(_filter(_v, rawExpr='$hotel.endereco')) # from line 56, col 10.
            write('''</p>\r
\t\t\t\t\t</li>\r
''')
        write('''\t\t\t\t</ul>\r

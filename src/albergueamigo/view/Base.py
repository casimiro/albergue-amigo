...
__CHEETAH_genTime__ = 1291693090.7302279
__CHEETAH_genTimestamp__ = 'Tue Dec  7 01:38:10 2010'
__CHEETAH_src__ = 'Base.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Dec  7 00:59:00 2010'
...
\t<div id="content">\r
\t''')
        _v = VFSL([locals()]+SL+[globals(), builtin],"body",True) # u'$body' on line 39, col 2
        if _v is not None: write(_filter(_v, rawExpr=u'$body')) # from line 39, col 2.
        write(u'''\r
\t</div>\r
\t<!-- end #content -->\r
\t<div id="sidebar">\r
...
\t\t\t\t<ul>\r
''')
        for hotel in VFSL([locals()]+SL+[globals(), builtin],"last_hotels",True): # generated from line 47, col 6
            write(u'''\t\t\t\t\t<li>\r
\t\t\t\t\t\t<h3><a href="/hotels/view/''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"hotel.id",True) # u'$hotel.id' on line 49, col 33
            if _v is not None: write(_filter(_v, rawExpr=u'$hotel.id')) # from line 49, col 33.
            write(u'''">''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"hotel.nome",True) # u'$hotel.nome' on line 49, col 44
            if _v is not None: write(_filter(_v, rawExpr=u'$hotel.nome')) # from line 49, col 44.
            write(u'''</a></h3>\r
\t\t\t\t\t\t<p>''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"hotel.endereco",True) # u'$hotel.endereco' on line 50, col 10
            if _v is not None: write(_filter(_v, rawExpr=u'$hotel.endereco')) # from line 50, col 10.
            write(u'''</p>\r
\t\t\t\t\t</li>\r
''')
        write(u'''\t\t\t\t</ul>\r

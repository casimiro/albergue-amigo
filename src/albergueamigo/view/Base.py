...
__CHEETAH_genTime__ = 1291983845.1049459
__CHEETAH_genTimestamp__ = 'Fri Dec 10 10:24:05 2010'
__CHEETAH_src__ = 'Base.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Dec  9 23:49:44 2010'
...
\t\t<h2>N\xc3\xb3s sabemos o que voc\xc3\xaa merece</h2>\r
\t</div>\r
\t<div id="menu">\r
\t\t<ul>\r
...
\t\t\t<h2 class="title">\xc3\x9altimos hot\xc3\xa9is</h2>\r
\t\t\t<div class="content">\r
\t\t\t\t<ul>\r
''')
        for hotel in VFSL([locals()]+SL+[globals(), builtin],"last_hotels",True): # generated from line 53, col 6
            write(u'''\t\t\t\t\t<li>\r
\t\t\t\t\t\t<h3><a href="/hotels/view/''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"hotel.id",True) # u'$hotel.id' on line 55, col 33
            if _v is not None: write(_filter(_v, rawExpr=u'$hotel.id')) # from line 55, col 33.
            write(u'''">''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"hotel.nome",True) # u'$hotel.nome' on line 55, col 44
            if _v is not None: write(_filter(_v, rawExpr=u'$hotel.nome')) # from line 55, col 44.
            write(u'''</a></h3>\r
\t\t\t\t\t\t<p>''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"hotel.endereco",True) # u'$hotel.endereco' on line 56, col 10
            if _v is not None: write(_filter(_v, rawExpr=u'$hotel.endereco')) # from line 56, col 10.
            write(u'''</p>\r
\t\t\t\t\t</li>\r
''')
        write(u'''\t\t\t\t</ul>\r
